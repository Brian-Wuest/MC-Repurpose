...
public class TileEntityCoffer extends TileEntityLockableLoot implements ITickable
{
    /** Chest Contents */
    ...
    protected TileEntityCoffer(IronChestType type)
    {
        super();
        this.chestType = type;
    ...
    public void update()
    {
        ...
        {
            this.world.addBlockEvent(this.pos, ModRegistry.Coffer(), 3, ((this.numPlayersUsing << 3) & 0xF8) | (this.facing.ordinal() & 0x7));
        }
    ...
    public void openInventory(EntityPlayer player)
    {
        if (!player.isSpectator())
        {
            ...
            this.world.notifyNeighborsOfStateChange(this.pos, ModRegistry.Coffer(), false);
            this.world.notifyNeighborsOfStateChange(this.pos.down(), ModRegistry.Coffer(), false);
        }
    }
    ...
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        ...
        return new ContainerCoffer(playerInventory, this, this.chestType, this.chestType.xSize, this.chestType.ySize);
    }
    ...
    protected void sendTopStacksPacket()
    {
        ...
        //TODO: Repurpose.network.sendToAllAround(new MessageCrystalChestSync(this, stacks), new TargetPoint(world.provider.getDimension(), getPos().getX(), getPos().getY(), getPos().getZ(), 128));
    }
